...
const SettingsLayout = () => {
  ...
  return (
      <>
          <div className=" flex flex-col space-y-6 p-10 pb-16 md:block">
            ...
            <div className="flex flex-col space-y-8 lg:flex-row lg:space-x-12 lg:space-y-0">
              <aside className="-mx-4 lg:w-1/5">
               ...
               {(user.role.includes("admin"))?<></>:<div className={(user)? cn( buttonVariants({ variant: "ghost" }), "hover:bg-primary hover:underline", "justify-start"):''} onClick={()=> { window.location.href = `mailto:aryamanch14@gmail.com?subject=${encodeURIComponent("Request for Admin Acess")}`;} }>request for admin acess</div>}
